...
import com.Inderjeet.News.persistence.entities.news.NewsComment
import com.Inderjeet.News.persistence.entities.news.NewsCommentLike
import com.Inderjeet.News.persistence.entities.news.NewsCommentReply
import com.Inderjeet.News.persistence.entities.news.NewsCommentReplyLike
import com.Inderjeet.News.persistence.repository.*
...
class NewsCommentServiceImpl(
    ...
    override fun fetchAllComments(
        ...
        pageSize: Int,
        pageNumber: Int
    ): com.Inderjeet.News.rest.dto.PaginatedResponse<NewsCommentDto> {

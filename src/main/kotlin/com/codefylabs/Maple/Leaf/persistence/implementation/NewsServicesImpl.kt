...
import com.codefylabs.Maple.Leaf.rest.dto.NewsDto
...
class NewsServicesImpl(val newRepository:NewsRepositoryJPA)
    ...
    override fun getNews(pageNumber:Int,pageSize:Int): PageResponse<NewsDto> {
        val pageable: Pageable = PageRequest.of(pageNumber, pageSize)
        val page: Page<News?> = newRepository.findAll(pageable)
        return PageHelper.getPageResponse(page, NewsDto::class.java)
    }

    override fun getNewsById(id: String): Optional<News> {
